    ...
    <article>
        ...
        if ($ClienteData && $ClienteData['SendPostForm']):
            ...
            if ($cadastra->getResultado()):
                header("Location: painel.php?exe=users/update&create=true&userid={$cadastra->getResultado()}");
            else:
            ...
            <div class="label_line">
                ...
                <label class="label_medium">
                    ...
                    <select name = "user_level" title = "Selecione o nível de usuário" required >
                        ...
                        <option value="2" <?php if (isset($ClienteData['user_level']) && $ClienteData['user_level'] == 2) echo 'selected="selected"'; ?>>Admin</option>
                    </select>
                </label>
            </div><!-- LABEL LINE -->
